...
namespace KaraokeApp.Servicio
{
  public  class CONEXIONMAESTRA
    {
        //public static string conexion = "Data source=192.168.100.99;Initial Catalog=KARAOKECURSO;Integrated Security=false;User Id=luxorcurso;Password=luxor";
